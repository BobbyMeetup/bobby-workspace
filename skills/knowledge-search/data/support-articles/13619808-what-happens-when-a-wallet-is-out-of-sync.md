---
title: What happens when a wallet is out of sync?
intercom_id: '13619808'
workspace_id: ourx4xix
state: published
default_locale: en
parent_type: null
parent_id: null
updated_at: 1770220067
description: >-
  When a wallet in Edge is in sync, it means that it's up to date with the
  latest blockchain data. The blockchain is essentially a decentral...
url: >-
  https://help.edge.app/en/articles/13619808-what-happens-when-a-wallet-is-out-of-sync
---
...
1.  **Balance Discrepancies:** One of the most common issues is an inaccurate wallet balance display. You may not see the correct amount of cryptocurrency you own or the correct value in your national currency. This can be alarming, especially for those who rely on their wallets for tracking their investments.
    
2.  **Inability to Send Funds:** Another significant impact is the inability to send out funds. While you might still receive cryptocurrency into your wallet, attempting to send any out could result in errors or failures. This can be frustrating, especially if you need to make timely transactions.
...
If you have any questions or need more assistance with this process, please contact [support@edge.app](http://support@edge.app)
