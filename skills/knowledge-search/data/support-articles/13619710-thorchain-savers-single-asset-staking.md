---
title: 'THORChain Savers: Single asset staking.'
intercom_id: '13619710'
workspace_id: ourx4xix
state: draft
default_locale: en
parent_type: null
parent_id: null
updated_at: 1770219912
description: "\_\nWith the introduction of THOR to the Edge application comes the exciting new feature of Single asset staking. With Thorchain Savers you'..."
---
With the introduction of THOR to the Edge application comes the exciting new feature of Single asset staking. **With Thorchain Savers you're able to stake your single asset and earn yield**. For a breakdown of what you can earn you can review the rates in the individual wallets or by visiting this website: [https://thorchain.net/pools/savers](https://thorchain.net/pools/savers).
...
1.  Download and install the Edge Wallet app on your smartphone or tablet. The Edge Wallet app is available for both iOS and Android devices through the AppStore or Playstore.
    
2.  Open Edge Wallet app and create a new account. You will need to enter a username and create a strong password to secure your account.
    
3.  Once your account is set up, Tap "Assets" located within the bottom navigation bar
    
4.  Tap on a wallet from the wallets list scene that supports Thorchain Savers.
    
5.  Tap on Stake
    
6.  Enter an amount you wish to stake
    
7.  Slide to confirm
    
8.  Once staked, you will start earning interest on your deposit. The amount of interest earned will depend on the overall performance of the liquidity pool and the amount of cryptocurrency you have staked.
