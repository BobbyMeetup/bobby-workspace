---
title: 'I forgot my username and/or password, how can I access my account?'
intercom_id: '13619840'
workspace_id: ourx4xix
state: published
default_locale: en
parent_type: null
parent_id: null
updated_at: 1770220119
description: >-
  Edge does not have access to accounts or maintain any information about our
  users. During the account creation process, Edge never asks fo...
url: >-
  https://help.edge.app/en/articles/13619840-i-forgot-my-username-and-or-password-how-can-i-access-my-account
---
...
If you still have access to the account through either the 4-digit PIN or biometrics login, you will be able to reset the password. (Note, this only works if Edge was not uninstalled or deleted from your device.) To initiate a password reset, please log-out and log-in to your account multiple times in a row, until a password reminder popup is displayed, allowing you to reset the password.

If account Recovery Questions were set up **before** losing access to your account, you may have saved or emailed to yourself a "recovery token" that can be used in the case of forgotten password. Note: This token is not sent from Edge, it is sent/shared by you (from Edge) to your choice of messaging or storage method (such as email, drive, etc.). The subject line to search for is "Edge Recovery Token."
...
The username for your Edge account can be any combination of letters, numbers, or symbols; and must be a minimum of three (3) characters long.

The password must contain at least ten (10) characters, and
